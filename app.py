...
# --- 3. THE SLIM TOP BAR (With Tooltips Restored) ---
...
with c3:
    extend_mode = st.checkbox(
        "Extend Bit", 
        value=False, 
        help="Suggest 3-5 ways to keep the joke going or find a new angle."
    )

with c4:
    local_ref_mode = st.checkbox(
        "Local Refs", 
        value=False, 
        help="Inject specific landmarks, culture, and inside jokes for the selected city."
    )
